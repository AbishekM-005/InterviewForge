      ...
      <div className="card-body p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg sm:text-2xl font-black">Live Sessions</h2>
          </div>
        ...
        {/* SESSIONS LIST */}
        <div className="space-y-3 max-h-[400px] overflow-y-auto pr-0 sm:pr-2">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              <div className="w-20 h-20 mx-auto bg-gradient-to-br from-primary/20 to-secondary/20 rounded-3xl flex items-center justify-center">

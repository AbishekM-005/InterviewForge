export const PROBLEMS = {
  ...
  "merge-sorted-array": {
    ...
    description: {
      ...
      notes: [
        ...
        "nums1 has a length of m + n, where the last n elements are empty and should be ignored.",
      ],
    },
    examples: [
      {
  ...
  "best-time-to-buy-and-sell-stock": {
    ...
    description: {
      ...
      notes: [
        "You want to maximize your profit by choosing a single day to buy and a different day to sell in the future.",
      ],
    },
    examples: [
      {
